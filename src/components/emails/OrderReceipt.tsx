...
export default function OrderReceipt({shippingAddress, orderId, orderDate}: {
        ...
        >
          ...
          >
            ...
            <Text style={{...global.text, marginTop: 24}}>
              If you have any question regarding your order , please feel free to contact us with your order number and we're to help
            </Text>
            </Section>
          ...
          <Section style={paddingY}>
            <Row>
              <Text style={{...footer.text , paddingTop: 30 , paddingBottom: 30}}>
                  Please contact us if you have any questions. (If you reply to our email , we wont be able to see it)
              </Text>
            </Row>
