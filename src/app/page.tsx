...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper
          className="pb-24 sm:pb-32 lg:pb-52 pt-10 lg:pt-24 xl:pt-32 lg:grid lg:grid-cols-3 lg:gap-x-0 xl:gap-x-8"
        >
        ...
        flex flex-col items-center lg:items-start"
            >
              ...
              <h1
                className="relative w-fit tracking-tighter text-balance mt-16 font-bold
          ...
          "
              ...
              <ul
                className="mt-8 space-y-2 flex flex-col items-center md:items-start
          ...
          <div className="relative md:max-w-xl">
            ...
            " />
            <img src="/line.png" alt="line" className="absolute w-20 -left-6
            select-none -bottom-6
            " />
    ...
    <section className="bg-slate-100 py-24">
      ...
      <div className="mx-auto grid max-w-2xl px-4 grid-cols-1 lg:mx-0 lg:max-w-none
    ...
    <div className="flex flex-auto flex-col lg:pr-8 xl:pr-20">
        ...
        <div className="text-lg leading-8">
          <p>"The case feels durable and I even got a compliment on the design.Had the case for 2 and a half months now and <span  className="p-0.5 bg-slate-800 text-white">the image is super clear now</span> on the case I had before, the image started fading into yellow-ish color after a couple weeks. Love it"</p>
        </div>

        <div className="flex gap-4 mt-2">
            <img className="rounded-full object-cover h-12 w-12" src="/users/user-1.png" alt="user" />
    ...
    <div className="flex flex-auto flex-col lg:pr-8 xl:pr-20">
        ...
        <div className="text-lg leading-8">
          <p>"I usually keep m phone together with my keys in my pockets and that let to some pretty heavy scratch marks of all my last phone cases. This one , besides a barely noticeable scratch on the corner, {" "} <span  className="p-0.5 bg-slate-800 text-white">looks brand new after about half a year</span>. I dig it"</p>
        </div>

        <div className="flex gap-4 mt-2">
            <img className="rounded-full object-cover h-12 w-12" src="/users/user-4.jpg" alt="user" />
            <div className="flex flex-col">
    ...
    <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
        ...
        <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-500/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
