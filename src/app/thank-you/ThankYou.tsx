...
export default async function ThankYou() {
  ...
  return (
        ...
        <div className="mt-10 border-t border-zinc-200">
            <div className="mt-10 flex flex-auto flex-col">
                ...
                <p className="mt-2 text-sm text-zinc-600">
                    We at CaseCobra beleive that a phone case does'nt only need to look good, 
                    but also last for the years to come. we offer a 5 year print gurantee: If your case 
    ...
    <div
    className="grid grid-cols-2 gap-x-6 border-t border-zinc-200 py-10 text-sm"
    >
        <div className="">
    ...
    <div
    className="space-y-6 pt-10 text-sm border-t border-zinc-200"
    >
